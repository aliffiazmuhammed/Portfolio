...
const WORDS = ["Self Learner", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Express","Mongodb"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/aliffiazmuhammed" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/alif-fiaz-muhammed-01b3ab22b/",
  },
];
